    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', 'male'), ('female', 'male')], default='female', max_length=6, verbose_name='gender')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=django.utils.datetime_safe.datetime.now, verbose_name='join time')),
            ],
            options={
                'verbose_name': 'texto verification code',
                'verbose_name_plural': 'texto verification code',
            },
        ),
    ]
