          ...
          <div class="main_nav_link" @mouseover="overAllmenu" @mouseout="outAllmenu">
            ...
            <div class="main_cata" id="J_mainCata" v-show="showAllmenu">
              <ul>
                ...
                <li
                  class="first"
                  v-for="(item,index) in allMenuLabel"
                  :key="index"
                  @mouseover="overChildrenmenu(index)"
...
export default {
  ...
  methods: {
    ...
    getMenu() {
      // Displays the categories in a drop-down menu
      getCategory({
        params: {}
      })
        .then(response => {
    ...
    getHotSearch() {
      //Gets the trending/popular searches
      getHotSearch()
        .then(response => {
